...
def load_model(ckpt_path: str ="apply_filter/src/basemodels/dlib_resnet_state_dict.pth.pth")->torch.nn.Module:
    """Load model from ckpt path and create a simple transform for input of model"""

    # load model from pth file
    model = DlibResnet()
    model.load_state_dict(torch.load(f="facial_landmarks_pad/facial_landmarks/models/last3.pth"))
